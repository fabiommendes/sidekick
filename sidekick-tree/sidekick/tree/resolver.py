...
#     """
#     Resolvers are special objects that map string paths to places in a tree.
#
#     The default strategy is to associate each part of a path to a string
#     attribute of the node that identify it among its siblings.
#     """
#
#     _match_cache = {}
#
...
#
#         >>> from sidekick.collections import Tree
#         >>> top = Tree("top", [
#         ...     Node("sub0", [
#         ...         Node("sub0sub0"),
#         ...         Node("sub0sub1"),
#         ...     ]),
#         ...     Node("sub1", parent=top),
#         ... ])
#
...
#           ...
#         ox.tree.resolver.ChildResolverError: Node('/top') has no child sub2. Children are: 'sub0', 'sub1'.
#
#         Absolute paths:
#
#         >>> r.get(sub0sub0, "/top")
...
#         Traceback (most recent call last):
#           ...
#         ox.tree.resolver.ResolverError: root node missing. root is '/top'.
#         >>> r.get(sub0sub0, "/bar")
#         Traceback (most recent call last):
#           ...
#         ox.tree.resolver.ResolverError: unknown root node '/bar'. root is '/top'.
#         """
...
#             if _getattr(child, self._attr) == name:
#                 return child
#         raise ChildResolverError(node, name, self._attr)
#
...
#         Traceback (most recent call last):
#             ...
#         ox.tree.resolver.ChildResolverError: Node('/top/sub1') has no child sub1. Children are: 'sub0'.
#
...
#             node = node.root
#             rootpart = _getattr(node, self._attr)
#             parts.pop(0)
#             if not parts[0]:
...
#         matches = []
#         for child in node.children:
#             name = _getattr(child, self._attr)
#             try:
